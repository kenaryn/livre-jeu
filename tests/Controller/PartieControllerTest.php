...
class PartieControllerTest extends WebTestCase
{
    ...
    public function testShow(): void
    {
        ...
        $fixture->setAventurier(new Personnage('My Title'));
        $fixture->setAventure(new Aventure('My Title'));
        $fixture->setEtape(new Etape('My Title'));
    ...
    public function testEdit(): void
    {
        ...
        $fixture = new Partie();
        $fixture->setDatePartie(new \DateTime());
        $fixture->setAventurier(new Personnage('Value'));
        $fixture->setAventure(new Aventure('Value'));
        $fixture->setEtape(new Etape('Value'));
    ...
    public function testRemove(): void
    {
        $this->markTestIncomplete();
        $fixture = new Partie();
        $fixture->setDatePartie(new \DateTime('Value'));
        $fixture->setAventurier(new Personnage('Value'));
        $fixture->setAventure(new Aventure('Value'));
        $fixture->setEtape(new Etape('Value'));
